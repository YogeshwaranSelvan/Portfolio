            ...
            <div className='bg-gray-100 py-12'>
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                    <div className='text-center'>
                        ...
                        <p className='mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl'>Hi, I'm Yogeshwaran selvan</p>
                    ...
                    <div className='mt-12'>
                        ...
                        <p className='mt-4 text-lg text-gray-600'>
                        Apart from coding, I'm driven by a passion for continuous learning and exploration of emerging technologies. I dedicate myself to staying current with the latest advancements in web development, ensuring my skills remain sharp and adaptable. Through hands-on projects and personal coding challenges, I apply my knowledge to real-world problems, fostering a deeper understanding of the technologies that shape our digital landscape.
                        </p>
                    </div>
                </div>
            </div>
