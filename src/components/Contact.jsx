        ...
        <div className='flex flex-col md:flex-row justify-between items-center'>
            <div className='md:w-1/2 mb-8 ml-2 md:mb-0'>
              ...
              <div className='flex space-x-4'>
                ...
                <a href="https://www.linkedin.com/in/yogeshwaran-selvan-b736921bb" target='blank' className='text-foreground/60 hover:text-foreground/80'>
                <img src={linkedin} alt="" className='h-6 w-6'/></a>

                <a href="https://www.instagram.com/yogesh_yo___" target='blank' className='text-foreground/60 hover:text-foreground/80'>
                <img src={instagram} alt="" className='h-6 w-6'/></a>

                <a href="https://x.com/Yogesh_yo___" target='blank' className='text-foreground/60 hover:text-foreground/80'>
                <img src={x} alt="" className='h-6 w-6'/></a>
